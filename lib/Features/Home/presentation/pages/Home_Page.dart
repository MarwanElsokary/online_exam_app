  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
          ...
          destinations: [
            NavigationDestination(icon:SvgPicture.asset(AssetsManager.hometab,
              colorFilter: ColorFilter.mode(Colors.blueAccent,BlendMode.srcIn),
            ),
              label:StringsManager.homeTab,selectedIcon: SvgPicture.asset(AssetsManager.hometab,
                colorFilter: ColorFilter.mode(
                    Colors.blueAccent
                    ,BlendMode.srcIn
                ),
              ),)
            ,NavigationDestination(icon:SvgPicture.asset(AssetsManager.resultstab
              ,colorFilter: ColorFilter.mode(
                  Colors.blueAccent,BlendMode.srcIn
              ),
            ), label:StringsManager.result,
              selectedIcon: SvgPicture.asset(AssetsManager.resultstab,
                colorFilter: ColorFilter.mode(
                    Colors.blueAccent
                    ,BlendMode.srcIn
                ),
              ),)
            ,NavigationDestination(icon:SvgPicture.asset(AssetsManager.profiletab
              ,colorFilter: ColorFilter.mode(
                  Colors.blueAccent ,BlendMode.srcIn
              ),), label:StringsManager.profileTab,selectedIcon: SvgPicture.asset(AssetsManager.profiletab,
              colorFilter: ColorFilter.mode(
                  Colors.blueAccent
                  ,BlendMode.srcIn
              ),
